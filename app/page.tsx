  ...
  return (
    <>
      <style>{`
        ...
        .counter-text { font-size: 0.85rem; color: var(--muted); font-family: 'Inter', sans-serif; }
        ...
        .app-preview-glow {
          position: absolute;
          inset: -20px;
          background: radial-gradient(ellipse at 50% 60%, rgba(196,123,58,0.12) 0%, transparent 70%);
          border-radius: 32px;
          pointer-events: none;
          z-index: 0;
        }
        ...
        .cta-final .form-wrap { justify-content: center; margin: 0 auto 0.5rem; }
        ...
        @media (max-width: 900px) {
          ...
          .app-preview-wrapper { max-width: 320px; }
        }
        @media (max-width: 600px) {
          ...
          .app-preview-wrapper { max-width: 260px; }
        }
      `}</style>
